...
class DemoDataGenerator:
    ...
    SA_STOCKS = [
        ...
        {"symbol": "SHP", "name": "Shoprite Holdings", "price": 180.00, "type": "stock"},
        {"symbol": "SBK", "name": "Standard Bank Group", "price": 145.00, "type": "stock"},
        {"symbol": "STX40", "name": "Satrix Top 40 ETF", "price": 85.00, "type": "etf"},
        {"symbol": "RES", "name": "Resilient REIT", "price": 12.00, "type": "stock"},
        {"symbol": "BTI", "name": "British American Tobacco", "price": 520.00, "type": "stock"},
    ...
    TRANSACTION_PATTERNS = {
        "income": [
            {"desc": "Salary - {company}", "amount_range": (35000, 55000), "frequency": "monthly", "day": 25},
            {"desc": "Freelance - {client}", "amount_range": (3000, 15000), "frequency": "irregular"},
            {"desc": "Investment Dividend", "amount_range": (500, 2500), "frequency": "quarterly"},
        ],
        "recurring_expenses": [
            {"desc": "Rent - {landlord}", "amount_range": (8000, 15000), "frequency": "monthly", "day": 1, "category": "Housing"},
            {"desc": "Electricity - Eskom", "amount_range": (800, 1500), "frequency": "monthly", "day": 5, "category": "Utilities"},
            {"desc": "Water & Rates - Municipality", "amount_range": (400, 800), "frequency": "monthly", "day": 5, "category": "Utilities"},
            {"desc": "Internet - {isp}", "amount_range": (699, 999), "frequency": "monthly", "day": 10, "category": "Utilities"},
            {"desc": "Cell Phone - {provider}", "amount_range": (299, 799), "frequency": "monthly", "day": 10, "category": "Utilities"},
            {"desc": "Car Insurance - {insurer}", "amount_range": (1200, 2000), "frequency": "monthly", "day": 15, "category": "Insurance"},
            {"desc": "Medical Aid - {provider}", "amount_range": (2500, 4000), "frequency": "monthly", "day": 15, "category": "Healthcare"},
            {"desc": "Gym - Virgin Active", "amount_range": (550, 850), "frequency": "monthly", "day": 1, "category": "Health & Fitness"},
            {"desc": "Netflix Subscription", "amount_range": (99, 199), "frequency": "monthly", "day": 12, "category": "Entertainment"},
            {"desc": "Spotify Premium", "amount_range": (59, 119), "frequency": "monthly", "day": 15, "category": "Entertainment"},
            {"desc": "DSTV Subscription", "amount_range": (299, 899), "frequency": "monthly", "day": 1, "category": "Entertainment"},
        ],
        "variable_expenses": [
            {"desc": "Woolworths - Groceries", "amount_range": (300, 1200), "frequency": "weekly", "category": "Groceries"},
            {"desc": "Pick n Pay - Groceries", "amount_range": (400, 1500), "frequency": "weekly", "category": "Groceries"},
            {"desc": "Checkers - Groceries", "amount_range": (350, 1000), "frequency": "weekly", "category": "Groceries"},
            {"desc": "Uber - Transport", "amount_range": (50, 300), "frequency": "weekly", "category": "Transport"},
            {"desc": "Petrol - {station}", "amount_range": (400, 800), "frequency": "weekly", "category": "Transport"},
            {"desc": "{restaurant} - Dining", "amount_range": (150, 600), "frequency": "weekly", "category": "Dining Out"},
            {"desc": "Takealot - Online Shopping", "amount_range": (200, 2000), "frequency": "monthly", "category": "Shopping"},
            {"desc": "{store} - Clothing", "amount_range": (300, 1500), "frequency": "monthly", "category": "Shopping"},
            {"desc": "Clicks - Personal Care", "amount_range": (100, 500), "frequency": "monthly", "category": "Personal Care"},
            {"desc": "Dischem - Pharmacy", "amount_range": (150, 600), "frequency": "monthly", "category": "Healthcare"},
            {"desc": "Movie - {cinema}", "amount_range": (80, 250), "frequency": "monthly", "category": "Entertainment"},
            {"desc": "Coffee - {cafe}", "amount_range": (35, 80), "frequency": "weekly", "category": "Dining Out"},
        ]
    }
    ...
    def generate_categories(self) -> List[Dict[str, Any]]:
        ...
        categories = [
            # Income
            {"id": "cat_salary", "name": "Salary", "group": "income", "color": "#10b981", "icon": "Briefcase", "is_system": "true", "created_at": now},
            {"id": "cat_freelance", "name": "Freelance", "group": "income", "color": "#059669", "icon": "Code", "is_system": "false", "created_at": now},
            {"id": "cat_investment_income", "name": "Investment Income", "group": "income", "color": "#047857", "icon": "TrendingUp", "is_system": "false", "created_at": now},
            
            # Needs
            {"id": "cat_housing", "name": "Housing", "group": "needs", "color": "#3b82f6", "icon": "Home", "is_system": "true", "created_at": now},
            {"id": "cat_groceries", "name": "Groceries", "group": "needs", "color": "#2563eb", "icon": "ShoppingCart", "is_system": "true", "created_at": now},
            {"id": "cat_utilities", "name": "Utilities", "group": "needs", "color": "#1d4ed8", "icon": "Zap", "is_system": "true", "created_at": now},
            {"id": "cat_transport", "name": "Transport", "group": "needs", "color": "#1e40af", "icon": "Car", "is_system": "true", "created_at": now},
            {"id": "cat_insurance", "name": "Insurance", "group": "needs", "color": "#1e3a8a", "icon": "Shield", "is_system": "true", "created_at": now},
            {"id": "cat_healthcare", "name": "Healthcare", "group": "needs", "color": "#7c3aed", "icon": "Heart", "is_system": "true", "created_at": now},
            
            # Wants
            {"id": "cat_dining", "name": "Dining Out", "group": "wants", "color": "#f59e0b", "icon": "Coffee", "is_system": "true", "created_at": now},
            {"id": "cat_entertainment", "name": "Entertainment", "group": "wants", "color": "#d97706", "icon": "Film", "is_system": "true", "created_at": now},
            {"id": "cat_shopping", "name": "Shopping", "group": "wants", "color": "#b45309", "icon": "ShoppingBag", "is_system": "true", "created_at": now},
            {"id": "cat_fitness", "name": "Health & Fitness", "group": "wants", "color": "#92400e", "icon": "Activity", "is_system": "false", "created_at": now},
            {"id": "cat_personal_care", "name": "Personal Care", "group": "wants", "color": "#ec4899", "icon": "Sparkles", "is_system": "false", "created_at": now},
            
            # Savings
            {"id": "cat_savings", "name": "Savings", "group": "savings", "color": "#8b5cf6", "icon": "PiggyBank", "is_system": "true", "created_at": now},
            {"id": "cat_investment", "name": "Investment", "group": "savings", "color": "#7c3aed", "icon": "TrendingUp", "is_system": "true", "created_at": now},
        ]
    ...
    def generate_transactions(self, accounts: List[Dict], categories: List[Dict]) -> List[Dict[str, Any]]:
            ...
            if pattern["frequency"] == "weekly":
                ...
                while current_date <= self.end_date:
                    ...
                    if month_key not in month_tracker and random.random() < 0.05:
                        ...
                        account = credit_acc if "Shopping" in pattern["category"] else checking_acc
    ...
    def generate_recurring_transactions(self, accounts: List[Dict], categories: List[Dict]) -> List[Dict[str, Any]]:
