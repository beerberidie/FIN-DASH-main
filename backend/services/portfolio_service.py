...
class PortfolioService:
    ...
    def get_portfolio_summary(self, base_currency: str = "USD") -> PortfolioSummary:
        ...
        sorted_by_performance = sorted(
            performances,
            key=lambda p: p.profit_loss_percentage,
            reverse=True
        )
    ...
    def _calculate_asset_allocation(
        ...
        for inv_type in allocation:
            ...
            allocation[inv_type]['percentage'] = (type_value / total_value * 100) if total_value > 0 else 0
    ...
    def get_investments_by_type(self, investment_type: str) -> List[InvestmentPerformance]:
        """
