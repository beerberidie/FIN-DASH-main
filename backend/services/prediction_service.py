...
class PredictionService:
    ...
    def predict_metric(
        ...
        if method == "moving_average":
            ...
            predictions = self._predict_linear_regression(historical_data, periods_ahead)
    ...
    def _predict_moving_average(
        ...
        std_dev = statistics.stdev(recent_values) if len(recent_values) > 1 else avg_value * 0.1
    ...
    def _predict_seasonal(
        ...
        for i in range(1, periods_ahead + 1):
            ...
            # Get seasonal value
            predicted_value = seasonal_pattern.get(next_month, statistics.mean(seasonal_pattern.values()))
            ...
            std_dev = statistics.stdev(month_values) if len(month_values) > 1 else predicted_value * 0.1
