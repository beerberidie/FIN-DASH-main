...
class Categorizer:
    ...
    MERCHANT_PATTERNS = {
        # Groceries (Needs)
        'cat_needs_groceries': [
            r'pick\s*n\s*pay', r'pnp\s', r'woolworths', r'woolies',
            r'checkers', r'shoprite', r'spar', r'boxer', r'usave',
            r'food\s*lover', r'makro', r'game\s*store', r'cambridge',
        ],
        
        # Transport (Needs)
        'cat_needs_transport': [
            r'uber', r'bolt', r'taxify', r'gautrain', r'metrorail',
            r'shell', r'engen', r'bp\s', r'caltex', r'sasol', r'total',
            r'petrol', r'fuel', r'garage', r'filling\s*station',
        ],
        
        # Utilities (Needs)
        'cat_needs_utilities': [
            r'eskom', r'city\s*power', r'municipality', r'rates',
            r'water\s*bill', r'electricity', r'prepaid',
        ],
        
        # Data/Airtime (Needs)
        'cat_needs_data': [
            r'vodacom', r'mtn', r'cell\s*c', r'telkom', r'rain',
            r'airtime', r'data\s*bundle', r'recharge',
        ],
        
        # Eating Out (Wants)
        'cat_wants_dining': [
            r'nando', r'kfc', r'mcdonald', r'steers', r'wimpy',
            r'spur', r'ocean\s*basket', r'mugg\s*&\s*bean',
            r'vida', r'seattle', r'restaurant', r'cafe', r'coffee',
            r'pizza', r'burger', r'takeaway', r'uber\s*eats',
            r'mr\s*d', r'order\s*in',
        ],
        
        # Entertainment (Wants)
        'cat_wants_entertainment': [
            r'ster\s*kinekor', r'nu\s*metro', r'cinema', r'movie',
            r'netflix', r'showmax', r'dstv', r'multichoice',
            r'spotify', r'apple\s*music', r'youtube\s*premium',
            r'playstation', r'xbox', r'steam', r'game',
        ],
        
        # Subscriptions (Wants)
        'cat_wants_subscriptions': [
            r'subscription', r'monthly\s*fee', r'membership',
            r'gym', r'virgin\s*active', r'planet\s*fitness',
        ],
        
        # Shopping (Wants)
        'cat_wants_shopping': [
            r'takealot', r'superbalist', r'zando', r'spree',
            r'mr\s*price', r'edgars', r'woolworths\s*fashion',
            r'truworths', r'foschini', r'ackermans', r'pep',
            r'clicks', r'dis-chem', r'amazon', r'shein',
        ],
        
        # Savings
        'cat_savings_goals': [
            r'savings', r'investment', r'unit\s*trust',
            r'easy\s*equities', r'satrix', r'tfsa',
        ],
        
        # Debt Payments
        'cat_debt_credit_card': [
            r'credit\s*card', r'visa', r'mastercard', r'amex',
        ],
        
        'cat_debt_loan': [
            r'loan\s*payment', r'personal\s*loan', r'home\s*loan',
            r'vehicle\s*finance', r'capitec\s*loan', r'african\s*bank',
        ],
        
        # Income
        'cat_income_salary': [
            r'salary', r'payroll', r'wages', r'income',
        ],
        
        'cat_income_freelance': [
            r'freelance', r'consulting', r'contract', r'invoice',
        ],
    }
        ...
        try:
            ...
            for category_id, descriptions in category_descriptions.items():
                if len(descriptions) >= 2:  # Need at least 2 examples
                    ...
                    if meaningful_words:
                        self.user_patterns[category_id] = meaningful_words[:10]  # Top 10
