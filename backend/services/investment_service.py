...
from models.investment import (
    ...
    InvestmentPerformance, PriceUpdate,
    INVESTMENT_FIELDNAMES, INVESTMENT_TRANSACTION_FIELDNAMES
)
...
class InvestmentService:
    ...
    def _ensure_files_exist(self):
        ...
        try:
            ...
            csv_manager.write_csv("investment_transactions.csv", [], INVESTMENT_TRANSACTION_FIELDNAMES)
    ...
    def update_investment(self, investment_id: str, investment_update: InvestmentUpdate) -> Investment:
        """
    ...
    def delete_investment(self, investment_id: str) -> dict:
        ...
        csv_manager.write_csv("investments.csv", filtered_investments, INVESTMENT_FIELDNAMES)
        
        # Delete associated transactions
        transactions = csv_manager.read_csv("investment_transactions.csv")
        filtered_transactions = [
            txn for txn in transactions
            if txn.get('investment_id') != investment_id
        ]
        csv_manager.write_csv("investment_transactions.csv", filtered_transactions, INVESTMENT_TRANSACTION_FIELDNAMES)
        
        return {"message": f"Investment {investment_id} deleted successfully"}
    
    # Investment Transaction Operations
    
    def list_transactions(self, investment_id: Optional[str] = None) -> List[InvestmentTransaction]:
        """
    ...
    def create_transaction(self, transaction_data: InvestmentTransactionCreate) -> InvestmentTransaction:
        """
        ...
        csv_manager.append_csv("investment_transactions.csv", transaction_row, INVESTMENT_TRANSACTION_FIELDNAMES)
    ...
    def _update_investment_from_transaction(
        ...
        if transaction.type == "buy":
            ...
            total_cost = (current_quantity * current_avg_cost) + transaction.total_amount
