...
class DebtBase(BaseModel):
    ...
    debt_type: str = Field(..., pattern="^(credit_card|personal_loan|student_loan|mortgage|car_loan|other)$")
...
class DebtUpdate(BaseModel):
    ...
    debt_type: Optional[str] = Field(None, pattern="^(credit_card|personal_loan|student_loan|mortgage|car_loan|other)$")
