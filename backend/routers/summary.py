...
def get_summary():
    ...
    mom_changes = calculator.calculate_month_over_month_change(current_month, transactions, base_currency)

    # Calculate spending by group
    spending_by_group = calculator.calculate_spending_by_group(current_month, transactions, categories, base_currency)
