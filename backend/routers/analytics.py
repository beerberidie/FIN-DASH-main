...
from models.analytics import (
    TrendAnalysis, YoYReport, SpendingPattern, CategoryInsight,
    PredictionReport, FinancialHealthScore, HealthMetricBreakdown,
    CustomReport, DrillDownResult
)
...
def get_trend_analysis(
    metric: str,
    period_type: str = Query(default="monthly", description="Period type (monthly, quarterly, yearly)"),
    start_date: Optional[str] = Query(None, description="Start date filter (YYYY-MM-DD)"),
    end_date: Optional[str] = Query(None, description="End date filter (YYYY-MM-DD)"),
    category_id: Optional[str] = Query(None, description="Category ID for category-specific trends")
):
    """
...
def get_predictions(
    ...
    method: str = Query(default="moving_average", description="Prediction method (moving_average, linear_regression, seasonal)")
):
    """
...
def get_health_score(
    include_investments: bool = Query(default=True, description="Include investment metrics"),
    include_debts: bool = Query(default=True, description="Include debt metrics"),
    reference_date: Optional[str] = Query(None, description="Reference date for calculation (YYYY-MM-DD)")
):
    """
    ...
    reference_date_obj = datetime.strptime(reference_date, '%Y-%m-%d').date() if reference_date else None
